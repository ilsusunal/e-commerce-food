...
const campaignCard = mockMainPageData.campaingCards[0];
const featuredRecipes = mockMainPageData.featuredRecipes;
const dealsOfTheDay = mockMainPageData.dealsOfTheDay;
